...
public:
	...
	*/
	 ...
	 *
	 * a <= b iff every member of a is also a member of b
	 * Function does not modify *this nor b in any way
	 * Return true, if Set *this is a subset of b, otherwise false
	 *
	 */
	 //IMPLEMENT
	 ...
	 * Function does not modify *this nor b in any way
	 * Return true, if Set *this has the same elements as Set b, otherwise false
	 *
	 */
	 //IMPLEMENT
	bool operator==(const Set& b) const;
	 ...
	 * Function does not modify *this nor b in any way
	 * Return true, if Set *this stores the same elements as Set b, otherwise false
	 *
	 */
	 //IMPLEMENT
	bool operator!=(const Set& b) const;
	 ...
	 * a < b iff a <= b but not b <= a
	 * Function does not modify *this nor b in any way
	 * Return true, if Set *this is a strict subset of b, otherwise false
	 */
	 //IMPLEMENT
	bool operator<(const Set& b) const;
...
private:
	...
	* ***************************** */
	 ...
	 *
	 */
	friend Set operator+(Set S1, const Set& S2) //Note: call by value for S1
	{
		return (S1 += S2);
	}
